...
class DBClient:
    ...
    async def create_table(self):
        query = f"CREATE TABLE IF NOT EXISTS {self.Question.__tablename__} " \
    ...
    async def insert_question(self, question):
        query = f"INSERT INTO {self.Question.__tablename__} " \
    ...
    async def update_question(self, question_id, question):
        query = f"ALTER TABLE {self.Question.__tablename__} UPDATE " \
    ...
    async def delete_question(self, question_id):
        query = f"ALTER TABLE {self.Question.__tablename__} " \
